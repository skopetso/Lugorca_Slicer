...
/*#ifdef __WXOSX__
    ...
    StateColor box_border_colour(std::pair<wxColour, int>(wxColour("#009789"), StateColor::Normal)); // ORCA match border color with other input/combo boxes
...
void Tab::on_value_change(const std::string& opt_key, const boost::any& value)
{
    ...
    // LUGOWARE: Disabled support interface suggestion popup
    // (was causing support generation bugs when user clicked No)
...
void TabPrint::build()
{
    ...
    auto page = add_options_page(L("Quality"), "custom-gcode_quality"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("xy_hole_compensation_layer_step");
        optgroup->append_single_option_line("xy_hole_compensation_layer_step_thickness");
        optgroup->append_single_option_line("xy_hole_compensation_layer_step_start_on");
        ...
        optgroup->append_single_option_line("avoid_crossing_wall_offset");
    ...
    page = add_options_page(L("Multimaterial"), "custom-gcode_multi_material"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("heating_time");
    ...
    page = add_options_page(L("Others"), "custom-gcode_other"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("fuzzy_skin_layer_step");
        optgroup->append_single_option_line("fuzzy_skin_layer_step_thickness");
        optgroup->append_single_option_line("fuzzy_skin_layer_step_start_on");
...
void TabFilament::build()
{
    ...
    page = add_options_page(L("Multimaterial"), "custom-gcode_multi_material"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("filament_toolchange_slowdown_return_distance");
