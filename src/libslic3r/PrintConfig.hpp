...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionInt,                 xy_hole_compensation_layer_step))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionInt,                  inverse_infill_step_layers))
    ((ConfigOptionInt,                  crosszag_rotation_step_layers))
    ((ConfigOptionFloat,                crosszag_rotation_angle))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloats,              filament_toolchange_slowdown_return_distance))
