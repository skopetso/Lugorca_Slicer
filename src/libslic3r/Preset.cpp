...
static std::vector<std::string> s_Preset_print_options {
    ...
    "seam_position", "staggered_inner_seams", "wall_sequence", "is_infill_first", "sparse_infill_density", "disable_solid_infill", "fill_multiline", "sparse_infill_pattern", "lateral_lattice_angle_1", "lateral_lattice_angle_2", "infill_overhang_angle", "top_surface_pattern", "bottom_surface_pattern",
    "infill_direction", "solid_infill_direction", "counterbore_hole_bridging","infill_shift_step", "inverse_infill_step_layers", "crosszag_rotation_step_layers", "crosszag_rotation_angle", "sparse_infill_rotate_template", "solid_infill_rotate_template", "symmetric_infill_y_axis","skeleton_infill_density", "infill_lock_depth", "skin_infill_depth", "skin_infill_density",
    ...
    "max_travel_detour_distance", "avoid_crossing_wall_offset",
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "enable_wrapping_detection", "p_point_generation", "p_point_max_depth",
...
static std::vector<std::string> s_Preset_filament_options {/*"filament_colour", */ "default_filament_colour", "required_nozzle_HRC", "filament_diameter", "pellet_flow_coefficient", "volumetric_speed_coefficients", "filament_type",
    ...
    "ironing_fan_speed",
    // LUGOWARE: Filament ironing overrides removed
    ...
    "filament_toolchange_slowdown_speed_ratio", "filament_toolchange_slowdown_distance", "filament_toolchange_slowdown_return_distance", "filament_toolchange_slowdown_additional_temp", "filament_additional_prime", "filament_cell_zhop_height", "filament_dhop_ratio", "filament_all_speed_override", "filament_unretract_dwell_time", "retract_restart_extra_toolchange",
