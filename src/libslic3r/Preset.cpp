...
static std::vector<std::string> s_Preset_filament_options {/*"filament_colour", */ "default_filament_colour", "required_nozzle_HRC", "filament_diameter", "pellet_flow_coefficient", "volumetric_speed_coefficients", "filament_type",
    ...
    "filament_toolchange_slowdown_speed_ratio", "filament_toolchange_slowdown_distance", "filament_toolchange_slowdown_additional_temp", "filament_additional_prime", "filament_cell_zhop_height", "filament_dhop_ratio", "filament_all_speed_override", "filament_unretract_dwell_time", "retract_restart_extra_toolchange",
